...
def loadmodel():
	...
	num_recurrent_units = recurrent_units,
...
def step_decay(epoch):
	...
	drop = 0.5
	initial_lrate = .8 * train_progress
	drop *= train_progress
...
def run_training():
	...
	checkpointer = ModelCheckpoint(filepath=model_basename, verbose=1)
...
#		input_shape = input_shape[1:]
	...
	print ('Number of Frequency Dimensions: ', freq_dims, '\nNumber of Hidden Dimensions: ', hidden_dims)
	print ('Number of recurrent units: ', recurrent_units)
